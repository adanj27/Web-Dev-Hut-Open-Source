      ...
      <div className="w-full flex items-center">
        <div className="">
          <div>
            ...
            <p className="text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-[#6d2c6f] to-[#2b2662] py-1">
              mundo del
            </p>
            <h1 className="text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-[#ffffff] to-[#FFBFBF]">
              desarrollo{' '}
          ...
          <button className="w-[250px] bg-gradient-to-b from-[#ffffff] to-[#909090] py-2 px-5 rounded-[15px] flex items-center text-xl font-semibold">
